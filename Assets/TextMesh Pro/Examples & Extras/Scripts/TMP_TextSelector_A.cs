    ...
    public class TMP_TextSelector_A : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        void LateUpdate()
        {
            ...
            if (m_isHoveringObject)
            {
                ...
                {
                    //Logger.Log("[" + m_TextMeshPro.textInfo.characterInfo[charIndex].character + "] has been selected.");
                ...
                if (wordIndex != -1 && wordIndex != m_lastWordIndex)
                {
                    ...
                    //Logger.Log("Mouse Position: " + Input.mousePosition.ToString("f3") + "  Word Position: " + wordPOS.ToString("f3"));
